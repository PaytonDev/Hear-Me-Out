...
import { selectedSong } from "../../../../features/music-player/music-player-slice";
...
export default function SearchResults(props: SearchResultsProps) {
  ...
  // This is where we'll make the switch to the state current song
  const song = useAppSelector((state) => state.musicPlayer.currentSong);
  const dispatch = useAppDispatch();

  const handleSongClick = dispatch(selectedSong);
