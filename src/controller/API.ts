...
export const getAlbum = async (id: string, token: string | undefined): Promise<AxiosResponse> => {
  try {
    const results: AxiosResponse = await axios.get(spotifyUrl + `albums/${id}`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    return results;
  } catch (err: any) {
...
export const getAlbumSongs = async (id: string, token: string | undefined) => {
  try {
    const results: any = await axios.get(spotifyUrl + `albums/${id}/tracks`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    return results;
  } catch (err: any) {
...
export const getArtist = async (id: string, token: string | undefined): Promise<AxiosResponse> => {
  try {
    const results: AxiosResponse = await axios.get(spotifyUrl + `artists/${id}`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    return results;
  } catch (err: any) {
...
export const getArtistTopSongs = async (id: string, token: string | undefined) => {
  try {
    const results: any = await axios.get(spotifyUrl + `artists/${id}/top-tracks`, {
      headers: { Authorization: `Bearer ${token}` },
...
export const getArtistAlbums = async (
  ...
  try {
    const results: AxiosResponse = await axios.get(
      spotifyUrl + `artists/${id}/albums?restrictions="explicit`,
      {
        headers: { Authorization: `Bearer ${token}` },
      }
    );
...
export const getSong = async (id: string, token: string | undefined): Promise<AxiosResponse> => {
  try {
    const results: AxiosResponse = await axios.get(spotifyUrl + `tracks/${id}`, {
      headers: { Authorization: `Bearer ${token}` },
    });
    return results;
  } catch (err: any) {
