...
var require_base_request = __commonJS({
  "node_modules/spotify-web-api-node/src/base-request.js"(exports, module2) {
    "use strict";
...
var require_authentication_request = __commonJS({
  "node_modules/spotify-web-api-node/src/authentication-request.js"(exports, module2) {
    "use strict";
...
var require_webapi_request = __commonJS({
  "node_modules/spotify-web-api-node/src/webapi-request.js"(exports, module2) {
    "use strict";
    var Request = require_base_request();
...
var require_response_error = __commonJS({
  "node_modules/spotify-web-api-node/src/response-error.js"(exports, module2) {
...
var require_http_manager = __commonJS({
  "node_modules/spotify-web-api-node/src/http-manager.js"(exports, module2) {
    "use strict";
...
var require_spotify_web_api = __commonJS({
  "node_modules/spotify-web-api-node/src/spotify-web-api.js"(exports, module2) {
    "use strict";
    ...
    function SpotifyWebApi2(credentials2) {
      this._credentials = credentials2 || {};
    }
    SpotifyWebApi2.prototype = {
      setCredentials: function(credentials2) {
        for (var key in credentials2) {
          if (credentials2.hasOwnProperty(key)) {
            this._credentials[key] = credentials2[key];
          }
        }
      },
    ...
    SpotifyWebApi2._addMethods = function(methods) {
...
var require_server_methods = __commonJS({
  "node_modules/spotify-web-api-node/src/server-methods.js"(exports, module2) {
    "use strict";
    var AuthenticationRequest = require_authentication_request();
    var HttpManager = require_http_manager();
    module2.exports = {
...
var require_server = __commonJS({
  "node_modules/spotify-web-api-node/src/server.js"(exports, module2) {
    var SpotifyWebApi2 = require_spotify_web_api();
    var ServerMethods = require_server_methods();
    SpotifyWebApi2._addMethods(ServerMethods);
    module2.exports = SpotifyWebApi2;
  }
});

// functions/get-token.ts
__export(exports, {
  handler: () => handler
});
var import_spotify_web_api_node = __toModule(require_server());
var credentials = {
...
var spotifyApi = new import_spotify_web_api_node.default(credentials);
var handler = async (event, context) => {
  const body = JSON.parse(event.body);
  try {
    const response = await spotifyApi.authorizationCodeGrant(body.code);
